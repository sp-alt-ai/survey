...
if page == "📝 Take Survey":
    ...
    # PROGRESS BAR - Updates in real-time as they type!
    def calculate_progress():
        total = 18
        answered = 0
        
        # Check info fields (these update automatically as they type!)
        if st.session_state.get('student_name') and st.session_state.student_name.strip(): 
            answered += 1
        if st.session_state.get('section') and st.session_state.section.strip(): 
            answered += 1
        if st.session_state.get('date_filled'): 
            answered += 1
        
        # Check radio questions inside form
    ...
    st.markdown(f'<div class="progress-container"><div class="progress-header"><span>Survey Progress</span><span>{progress}%</span></div></div>', unsafe_allow_html=True)
    st.progress(progress)
    
    if not st.session_state.submitted:
        
        # STUDENT INFORMATION - OUTSIDE FORM for real-time updates!
        ...
        st.markdown('<div class="section-desc">Required for identification purposes (Progress updates as you type!)</div>', unsafe_allow_html=True)
        
        # These update automatically as students type!
        st.text_input("Full Name *", key="student_name", placeholder="Type your name here...")
        ...
        # THE REST OF THE SURVEY - INSIDE FORM
        with st.form("survey_form"):
            ...
            st.markdown('<p class="question-text">3. How often do you feel overwhelmed? <span class="required">*</span></p>', unsafe_allow_html=True)
            ...
            st.markdown('<p class="question-text">4. Who puts pressure on you? (Select all) <span class="required">*</span></p>', unsafe_allow_html=True)
            st.multiselect("Pressure", options=["Parents/Guardians", "Teachers", "Peers/Classmates", "Myself", "College prep", "Fear of low grades"], key="pressure_source", label_visibility="collapsed")
            st.markdown('<p class="question-text">5. Study hours on weekdays? <span class="required">*</span></p>', unsafe_allow_html=True)
            ...
            st.markdown('<p class="question-text">6. Has pressure affected your grades? <span class="required">*</span></p>', unsafe_allow_html=True)
            ...
            st.markdown('<p class="question-text">7. Test anxiety frequency? <span class="required">*</span></p>', unsafe_allow_html=True)
            ...
            st.markdown('<p class="question-text">8. Considered cheating due to pressure? <span class="required">*</span></p>', unsafe_allow_html=True)
            ...
            st.markdown('<p class="question-text">9. How often stressed? <span class="required">*</span></p>', unsafe_allow_html=True)
            ...
            st.markdown('<p class="question-text">12. Sleep sacrifice frequency? <span class="required">*</span></p>', unsafe_allow_html=True)
            ...
            st.markdown('<p class="question-text">14. Adequate school support? <span class="required">*</span></p>', unsafe_allow_html=True)
            ...
            st.markdown('<p class="question-text">15. Recommend system changes? <span class="required">*</span></p>', unsafe_allow_html=True)
